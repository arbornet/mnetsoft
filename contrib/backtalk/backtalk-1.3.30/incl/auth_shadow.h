...
/* AUTHENTICATION MODULE INTERFACE - Unix Shadow File Version
 *
...
#define HAVEAUTH_GETPASS		/* Fake - always returns "" */
...
#define HAVEAUTH_CHECKPASS		/* Run external authenticator */
