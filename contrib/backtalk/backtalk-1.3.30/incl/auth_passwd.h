...
/* AUTHENTICATION MODULE INTERFACE - Unix Password File Version
 *
...
#undef HAVEAUTH_GETPASS			/* Go ahead and use ident_getpwnam */
...
#undef HAVEAUTH_CHECKPASS		/* Default is fine */
...
#undef HAVEAUTH_WALK			/* Default is fine */
...
#undef HAVEAUTH_SEEK			/* Default is fine */
...
#undef HAVEAUTH_NEWPASS			/* Can't edit */
