...
/* IDENTITY MODULE INTERFACE - Flat Textfile Version
 *
...
#undef HAVEIDENT_WALK		/* Default is fine */
...
#undef HAVEIDENT_SEEK		/* Default is fine */
...
/* Ident_text needs the update_pw() function */

#ifndef NEED_UPDATE_PW
#define NEED_UPDATE_PW
#endif
